...
CREATE TABLE `fileupload` (
  ...
  `FileName` longtext,
  `FileUploadFileId` int DEFAULT NULL,
  `FileUrl` longtext,
  ...
  PRIMARY KEY (`FileId`),
  KEY `FK_FileUpload_FileUpload_FileUploadFileId` (`FileUploadFileId`),
  CONSTRAINT `FK_FileUpload_FileUpload_FileUploadFileId` FOREIGN KEY (`FileUploadFileId`) REFERENCES `fileupload` (`FileId`)
