...
namespace CDMS.Gateway
{
    public class BranchGateway : Gateway
    {
        public int Save(Branch aBranch)
        {
            ...
            try
            {
                Query = "INSERT INTO Branch (Name, CompanyId, Address, Email, Phone, CreatedBy, CreatedDate) " +
                        "VALUES(@name, @companyid, @address, @email, @phone, @createdBy, @createdDate)";
        ...
        public int Update(Branch aBranch)
        {
            ...
            try
            {
                Query = "UPDATE Branch SET Name = CompanyId = @companyid, Address = @address, Email = @email, Phone = @phone, " +
                                                            "UpdatedBy = @updatedBy, " +
